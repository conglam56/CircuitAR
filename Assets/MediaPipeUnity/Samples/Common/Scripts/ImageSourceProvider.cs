...
namespace Mediapipe.Unity.Sample
{
    public static class ImageSourceProvider
    {
        ...
        // MỚI THÊM: cho phép gán trực tiếp 1 ImageSource tuỳ chỉnh (ví dụ CustomARFrameBridge),
        // bỏ qua hệ thống enum/Switch có sẵn — dùng cho nguồn không nằm trong 3 loại mặc định.
        public static void SetCustomSource(ImageSource customSource)
        {
            ImageSource = customSource;
        }
    }
}